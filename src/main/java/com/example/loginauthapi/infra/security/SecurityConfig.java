    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/pecas/preco").permitAll()
                        .requestMatchers(HttpMethod.POST, "/pecas/listarPecas").permitAll()
                        .requestMatchers(HttpMethod.POST, "/pecas/quantidade").permitAll()
                        .requestMatchers(HttpMethod.POST, "/pecas/deletar").permitAll()
